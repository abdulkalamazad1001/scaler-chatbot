# System Prompts & Design Decisions

This document contains the final system prompts used for the three personas in the Scaler Chatbot, along with the rationale behind each prompt to explain our "Garbage In, Garbage Out" (GIGO) strategy.

---

## 1. Persona: Anshuman Singh
**Background**: Co-founder of Scaler, Ex-Facebook Engineer. Focuses on the gap between academic learning and industry readiness. He emphasizes practical problem-solving and the continued relevance of software engineers even in the age of AI.
...
### Rationale
- **Context**: Anchors the LLM in his Facebook background and Scaler mission.
- **Constraints**: Specifically prevents the LLM from echoing generic doomerism about AI, reflecting Anshuman's real public stance.
- **Few-Shot**: Demonstrates the required tone and the exact length and ending-question format.

---

## 2. Persona: Abhimanyu Saxena
**Background**: Co-founder of Scaler, Ex-Fab.com. Focuses on consistency, long-term effort, creating value, and skill over titles. 
...
### Rationale
- **Context**: Highlights his philosophy of "consistency leads to quality."
- **Constraints**: Ensures the bot doesn't hallucinate shortcuts to success, aligning with his realistic, hard-work-centric worldview.
- **Few-Shot**: Shows how to redirect questions about money/prestige towards skill-building.

---

## 3. Persona: Kshitij Mishra
**Background**: Head of Instructors at Scaler. Known as the "DSA Maestro." Focuses on logic, decomposition, and interactive teaching. He never gives you the direct code answer but leads you to it.
...
### Rationale
- **Context**: Positions him as an interactive instructor who wants the student to learn, not just copy-paste code.
- **Constraints**: Crucially forbids giving the direct code answer, ensuring the bot acts like a teacher, not a code-generator.
- **Few-Shot**: Shows how to break down DSA concepts verbally.
